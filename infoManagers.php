            ...
            <div>
                <h2>
                    ...
                    <?php
                        if (isset($_SESSION['email'])) { 
                            $email = $_SESSION['email']; 
                            $get = mysqli_query($conn, "select manager_id from managers where email = '$email' ");
                            $getData = $get->fetch_all(MYSQLI_ASSOC);
                            $mssv = $getData[0]['manager_id'];
            ...
            <div>
                <h2>
                    ...
                    <?php
                        if (isset($_SESSION['email'])) { 
                            $email = $_SESSION['email']; 
                            $get = mysqli_query($conn, "select date_of_birth from managers where email = '$email' ");
                            $getData = $get->fetch_all(MYSQLI_ASSOC);
            ...
            <div>
                <h2>
                    ...
                    <?php
                        if (isset($_SESSION['email'])) { 
                            $email = $_SESSION['email']; 
                            $get = mysqli_query($conn, "select gender from managers where email = '$email' ");
                            $getData = $get->fetch_all(MYSQLI_ASSOC);
            ...
            <div class="last-service">
                <h2>
                    ...
                    <?php
                        if (isset($_SESSION['email'])) { 
                            $email = $_SESSION['email']; 
                            $get = mysqli_query($conn, "select phone_number from managers where email = '$email' ");
                            $getData = $get->fetch_all(MYSQLI_ASSOC);
