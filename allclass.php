        ...
        <table border="1" id="spso_log_table">
                ...
                <?php
                    ...
                    $result = mysqli_query($conn, "SELECT 
                                                        classes.class_id AS ClassCode,
                                                        classes.course_id AS CourseCode,
                                                        courses.course_name AS CourseName,
                                                        lecturers.full_name AS InstructorName,  -- Assuming the table and column names.
                                                    ...
                                                    JOIN 
                                                        lecturers ON classes.lecturer_id = lecturers.lecturer_id  -- Joining the lecturers table.
                                                    ORDER BY 
